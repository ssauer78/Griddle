	...
	*/
	...
	var Griddle = React.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        var settings = localStorage.getItem('griddleSettings_' + this.props.uniqueIdentifier);
	        var columns = [];
	        if (settings) {
	        ...
	        this.columnSettings = new ColumnProperties(this.props.results.length > 0 ? deep.keys(this.props.results[0]) : [], columns, this.props.childrenColumnName, this.props.columnMetadata, this.props.metadataColumns);
	    ...
	    getFilter: function getFilter() {
	        return this.props.showFilter && this.shouldUseCustomGridComponent() === false ? this.props.useCustomFilterComponent ? React.createElement(CustomFilterContainer, { changeFilter: this.setFilter, placeholderText: this.props.filterPlaceholderText,
	            ...
	            currentResults: this.getCurrentResults(), uniqueIdentifier: this.props.uniqueIdentifier }) : React.createElement(GridFilter, { changeFilter: this.setFilter, placeholderText: this.props.filterPlaceholderText }) : "";
	    },
	...
	*/
	...
	var GridTable = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var pagingContent = React.createElement('div', null);
	...
	*/
	...
	var GridSettings = React.createClass({
	    ...
	    checkStorage: function checkStorage() {
	        // check if the localStorage exists
